export const BROKE_APP_BUILD_VERSION = "v59.43.4";

export const BROKE_APP_BUILD_NOTE =
  "Admin wallet transaction helper extraction, shared browser batch sender helpers, no payout or eligibility behavior changes.";
