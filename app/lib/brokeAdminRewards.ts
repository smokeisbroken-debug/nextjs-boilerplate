export const BROKE_APP_BUILD_VERSION = "v59.45.6";

export const BROKE_APP_BUILD_NOTE =
  "Leak Score research positioning polish with automatic local review readiness; no API scan, Supabase, or payout changes.";
