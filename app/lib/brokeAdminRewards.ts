export const BROKE_APP_BUILD_VERSION = "v59.43.3";

export const BROKE_APP_BUILD_NOTE =
  "Admin distribution helper extraction, shared payout/manifest helpers, no payout or eligibility behavior changes.";
